...
<head>
    ...
    <link rel="stylesheet" href="enterprisepurchasing.css" type="text/css">
...
<nav style="background-color: #ffffff " class="navbar  navbar-fixed-top " role="navigation">
    ...
    <div class="col-md-8">
        <ul class="nav navbar-nav col-md-12">
            ...
            <li class="col-md-2"><a href="enterprisepurchasing.php" target="_self" style="color: #ec8400">企业采购</a></li>
...
<script src="enterprisepurchasing.js"></script>
</body>
</html>